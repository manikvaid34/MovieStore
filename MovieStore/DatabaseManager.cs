...
namespace MovieStore
{
    ...
    {
        public string constring = @"Data Source = SYSTEM;Initial Catalog = MOVIE_STORE; Integrated Security = True";
        SqlConnection SqlConn = new SqlConnection("Data Source = SYSTEM;Initial Catalog = MOVIE_STORE; Integrated Security = True");
